...
const Sidebar = () => {
  const menus = [
    {name:'Deshboard', link:'/', icon: FaQrcode},
    {name:'User', link:'/', icon: FaHouseUser},
  ...
  return (
    ...
    <div className={`bg-black min-h-screen ${open ? 'w-72' : 'w-16'} text-gray-100 px-4`}>
      ...
      <div className='mt-4 flex flex-col gap-4 relative'>
        ...
        <Link to={menu?.icon} className={`${menu?.margin && 'mt-5'} group flex items-center text-sm gap-3.5 font-medium p-2 hover:bg-gray-800`}>
          <div>
